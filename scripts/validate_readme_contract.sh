...
require_text docs/DEPENDENCIES_AND_COMPATIBILITY.md 'The v0.3.0 release exposes the fixed EWD/CBD/RMD repository selector, lifecycle controls, deterministic retrieval and provenance UI.'
