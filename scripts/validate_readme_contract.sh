...
require_text STATUS.md 'R5 now has a benchmark framework and evaluator, but the exact reviewed benchmark corpus and a real gate-passing benchmark run are not yet claimed.'
