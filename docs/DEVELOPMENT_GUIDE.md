...
The Meson suite covers repository lifecycle, archive safety, manifests, storage, retrieval, grounding, citations and conversation pinning.
...
- `docs/USER_INTERFACE_GUIDE.md` — annotated application map;
