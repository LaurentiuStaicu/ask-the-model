...
![Annotated Ask the Model v0.3 interface map](../assets/application-map-v0.3.svg)

The diagram is a vector reconstruction of the application rather than a screenshot. It follows the project palette from the README design contract: `#333333`, `#707070`, `#a0a0a0`, white and black.
