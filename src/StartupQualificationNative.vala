namespace AskTheModel.StartupQualificationNative {
    ...
    [CCode (
        cname = "atm_startup_qualify_deployment",
        cheader_filename = "startup_qualification.h"
    )]
    public static extern bool qualify_deployment (
    ...
    [CCode (
        cname = "atm_repository_reconcile_local",
        cheader_filename = "repository_reconcile.h"
    )]
    public static extern bool reconcile_local (
        string cache_root,
