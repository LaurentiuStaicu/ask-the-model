...
- added C0-M2 measurement-only Control DB headroom scaling across 1/100/1000 real copy-on-write generations, warm versus cold SQLite WAL/SHM sidecar states, and 16/32/64/128 KiB free-space bands on isolated tmpfs filesystems; the artifact records DB/page/sidecar/capacity diagnostics and requires fail-closed authority integrity for every case while explicitly selecting no production state reserve;
